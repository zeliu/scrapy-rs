...
async fn main() -> Result<()> {
    ...
    signals
        .connect(Signal::EngineStarted, |_| {
            info!("Engine started");
            Ok(())
        })
        .await?;
    ...
    signals
        .connect(Signal::SpiderOpened, |args| {
    ...
    signals
        .connect(Signal::RequestScheduled, |args| {
    ...
    signals
        .connect(Signal::RequestSent, |args| {
            if let SignalArgs::Request(request) = args {
    ...
    signals
        .connect(Signal::ResponseReceived, |args| {
    ...
    signals
        .connect(Signal::ItemScraped, |args| {
    ...
    signals
        .connect(Signal::ErrorOccurred, |args| {
    ...
    signals
        .connect(Signal::SpiderClosed, |args| {
            if let SignalArgs::Spider(spider) = args {
    ...
    signals
        .connect(Signal::EngineStopped, |_| {
            info!("Engine stopped");
            Ok(())
        })
        .await?;
